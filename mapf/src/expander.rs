...
pub trait Initializable<Start, N: Node, G: Goal<N>> {
    ...
    type InitialNodes<'a>: IntoIterator<Item=Result<Arc<N>, Self::InitError>> where Self: 'a, Start: 'a, G: 'a;
...
pub trait Expandable<N: Node, G: Goal<N>> {
    ...
    type Expansion<'a>: IntoIterator<Item=Result<Arc<N>, Self::ExpansionError>> where Self: 'a, G: 'a;
