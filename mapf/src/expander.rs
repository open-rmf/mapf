...
pub trait Expander {
    ...
    type InitialNodes<'a>: IntoIterator<Item=Result<Arc<Self::Node>, Self::InitError>> where Self: 'a;
    ...
    type Expansion<'a>: IntoIterator<Item=Result<Arc<Self::Node>, Self::ExpansionError>> where Self: 'a;
...
pub type InitErrorOf<E> = <E as Expander>::InitError;
pub type ExpansionErrorOf<E> = <E as Expander>::ExpansionError;
pub type SolveErrorOf<E> = <E as Expander>::SolveError;
