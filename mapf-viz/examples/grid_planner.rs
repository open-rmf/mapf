...
impl SolutionVisual<Message> {
    fn new(cell_size: f64, agent_radius: f32, path_color: iced::Color) -> Self {
        ...
        let t_obs = Trajectory::from_iter([
            se2::timed_position::Waypoint::new(TimePoint::from_secs_f64(0.0), 5.0, 0.0, 180_f64.to_radians()),
            // se2::timed_position::Waypoint::new(TimePoint::from_secs_f64(10.0), -5.0, 0.0, 180_f64.to_radians()),
            se2::timed_position::Waypoint::new(TimePoint::from_secs_f64(1.0), 0.0, 0.0, 180_f64.to_radians()),
            se2::timed_position::Waypoint::new(TimePoint::from_secs_f64(2.0), 0.0, 0.0, -90_f64.to_radians()),
            se2::timed_position::Waypoint::new(TimePoint::from_secs_f64(5.0), 0.0, -3.0, -90_f64.to_radians()),
        ]).unwrap();
